...
// static void HashMapFreeEntrySingle(JSONValue *, bool);
// static void HashMapFreeEntryList(JSONValue *, bool);
// static void HashMapFreeEntries(JSONValue **, u_int32_t, bool, bool);
// static void HashMapPrintEntry(JSONValue *);
...
// static void HashMapFreeEntryList(JSONValue *entry, bool deep)
// {
//     if (entry == NULL)
//     {
//         errno = EINVAL;
...
// static void HashMapFreeEntrySingle(JSONValue *entry, bool deep)
// {
//     if (entry == NULL)
//     {
//         errno = EINVAL;
...
// static void HashMapFreeEntries(JSONValue **entries, u_int32_t size, bool deep, bool entry_values)
// {
//     if (entries == NULL)
//     {
//         errno = EINVAL;
...
// static void HashMapPrintEntry(JSONValue *entry)
// {
